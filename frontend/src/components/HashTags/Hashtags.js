...
import pers_footer from '../../image/pers-footer.png';
                ...
                <div className="tags-list__footer">
                    ...
                    <nav>
                        <ul className="tags-list__footer_soc-icon-lists">
                            <li className="tags-list__footer_soc-icon-list"><img className="tags-list__footer_soc-icon" src={logo_facebook} /></li>
